...
use SampleGameApi\GameApi;


//$server = new Server(new SampleGameApi\GameApi());
$server = new Server(new GameApi());
...
if (DEBUG == 1) {
    ...
    $req_dump = $req_dump.PHP_EOL;
    $fp = file_put_contents('debug/response.txt', $req_dump, FILE_APPEND);
} //DEBUG == 1
